...
\vspace{.1\baselineskip} %\vspace{.5\baselineskip}
...
\includegraphics[width=0.293\columnwidth]{old_v_anti_true_classique_Full_\block}
...
& &
\includegraphics[width=0.293\columnwidth]{old_v_anti_fit_true_Full_\block}
